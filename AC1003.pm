...
sub _read {
    ...
    for (my $i = 0; $i < $n_table_blocks; $i++) {
        push @{$self->{table_blocks}}, CAD::Format::DWG::AC1003::Block->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_layers} = ();
    my $n_table_layers = $self->header()->table_layer()->items();
    for (my $i = 0; $i < $n_table_layers; $i++) {
        push @{$self->{table_layers}}, CAD::Format::DWG::AC1003::Layer->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_styles} = ();
    my $n_table_styles = $self->header()->table_style()->items();
    for (my $i = 0; $i < $n_table_styles; $i++) {
        push @{$self->{table_styles}}, CAD::Format::DWG::AC1003::Style->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_linetypes} = ();
    my $n_table_linetypes = $self->header()->table_linetype()->items();
    for (my $i = 0; $i < $n_table_linetypes; $i++) {
        push @{$self->{table_linetypes}}, CAD::Format::DWG::AC1003::Linetype->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_views} = ();
    my $n_table_views = $self->header()->table_view()->items();
    for (my $i = 0; $i < $n_table_views; $i++) {
        push @{$self->{table_views}}, CAD::Format::DWG::AC1003::View->new($self->{_io}, $self, $self->{_root});
    }
    ...
    $self->{entities_block} = CAD::Format::DWG::AC1003::RealEntities->new($io__raw_entities_block, $self, $self->{_root});
    ...
    $self->{entities_extra} = CAD::Format::DWG::AC1003::RealEntities->new($io__raw_entities_extra, $self, $self->{_root});
    if (!($self->_io()->is_eof())) {
        $self->{todo} = ();
...
########################################################################
package CAD::Format::DWG::AC1003::EntityAttrib;
...
sub _read {
    ...
    $self->{point_from} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{flags} = CAD::Format::DWG::AC1003::AttrFlags->new($self->{_io}, $self, $self->{_root});
    ...
    if ($self->entity_common()->flag2_1()) {
        $self->{aligned_to} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::AC1003::LinetypeFlag;
...
########################################################################
package CAD::Format::DWG::AC1003::BlockFlag;
...
########################################################################
package CAD::Format::DWG::AC1003::EntityLine3d;
...
########################################################################
package CAD::Format::DWG::AC1003::Pattern;
...
sub _read {
    ...
    $self->{from} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{from_and} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{to} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{to_and} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
}
...
########################################################################
package CAD::Format::DWG::AC1003::UnknownDate;
...
########################################################################
package CAD::Format::DWG::AC1003::PolylineFlags;
...
########################################################################
package CAD::Format::DWG::AC1003::AttrFlags;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1003::LinetypeFlag->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{pattern} = CAD::Format::DWG::AC1003::Pattern->new($self->{_io}, $self, $self->{_root});
    $self->{u21} = $self->{_io}->read_s1();
}
...
########################################################################
package CAD::Format::DWG::AC1003::Point3d;
...
########################################################################
package CAD::Format::DWG::AC1003::UnknownRepeating;
...
########################################################################
package CAD::Format::DWG::AC1003::Point2d;
...
########################################################################
package CAD::Format::DWG::AC1003::ViewFlag;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1003::LayerFlag->new($self->{_io}, $self, $self->{_root});
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1003::BlockFlag->new($self->{_io}, $self, $self->{_root});
...
sub _read {
    ...
    $self->{insert_point} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{height} = $self->{_io}->read_f8le();
...
########################################################################
package CAD::Format::DWG::AC1003::EntityJump;
...
sub _read {
    ...
    $self->{start_point} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{height} = $self->{_io}->read_f8le();
    ...
    if ($self->entity_common()->flag2_1()) {
        $self->{end_point} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::AC1003::HeaderVariables;
...
sub _read {
    ...
    $self->{insertion_base} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{num_entities} = $self->{_io}->read_u2le();
    $self->{drawing_first} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{drawing_second} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{limits_min} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{limits_max} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{view_ctrl} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_size} = $self->{_io}->read_f8le();
    $self->{snap} = $self->{_io}->read_s2le();
    $self->{snap_resolution} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{snap_base} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{grid_unit} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{axis_value} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{view_dir} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_x} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_y} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_z} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_x_alt} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_y_alt} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_z_alt} = CAD::Format::DWG::AC1003::Point3d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{unknown_date} = CAD::Format::DWG::AC1003::UnknownDate->new($self->{_io}, $self, $self->{_root});
    ...
    if ($self->_parent()->num_header_vars() == 122) {
...
sub _read {
    ...
    $self->{center_point} = CAD::Format::DWG::AC1003::Point2d->new($self->{_io}, $self, $self->{_root});
...
sub _read {
    ...
    elsif ($_on == $CAD::Format::DWG::AC1003::ENTITIES_LINE3D) {
        $self->{data} = CAD::Format::DWG::AC1003::EntityLine3d->new($self->{_io}, $self, $self->{_root});
    }
    ...
    elsif ($_on == $CAD::Format::DWG::AC1003::ENTITIES_ATTRIB) {
        $self->{data} = CAD::Format::DWG::AC1003::EntityAttrib->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1003::ENTITIES_ATTDEF) {
        $self->{data} = CAD::Format::DWG::AC1003::EntityAttdef->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1003::ENTITIES_JUMP) {
        $self->{data} = CAD::Format::DWG::AC1003::EntityJump->new($self->{_io}, $self, $self->{_root});
    }
...
sub _read {
    ...
    $self->{table_block} = CAD::Format::DWG::AC1003::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_layer} = CAD::Format::DWG::AC1003::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_style} = CAD::Format::DWG::AC1003::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_linetype} = CAD::Format::DWG::AC1003::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_view} = CAD::Format::DWG::AC1003::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{variables} = CAD::Format::DWG::AC1003::HeaderVariables->new($self->{_io}, $self, $self->{_root});
}
...
########################################################################
package CAD::Format::DWG::AC1003::LayerFlag;
...
########################################################################
package CAD::Format::DWG::AC1003::DimType;
...
sub _read {
    ...
    if ($self->entity_common()->flag2_8()) {
        $self->{flag} = CAD::Format::DWG::AC1003::PolylineFlags->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_7()) {
        $self->{start_width} = $self->{_io}->read_f8le();
    }
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1003::ViewFlag->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1003::HeaderTable;
