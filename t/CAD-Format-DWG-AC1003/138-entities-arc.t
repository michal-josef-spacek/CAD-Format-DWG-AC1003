...
is($arc1_data->x, -4.09807621135332, 'Start point of arc x (-4.09807621135332).');
is($arc1_data->y, 7.09807621135332, 'Start point of arc y (7.09807621135332).');
...
is($entity_common->entity_layer_index, 0, 'Arc layer index (0).');
is($entity_common->entity_size, 48, 'Entity size (48).');
is($arc1_data->x, -0.0839514779065636, 'Start point of arc x (-0.0839514779065636).');
is($arc1_data->y, 3.08395147790656, 'Start point of arc y (3.08395147790656).');
