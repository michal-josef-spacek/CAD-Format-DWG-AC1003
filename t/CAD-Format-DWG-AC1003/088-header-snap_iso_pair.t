...
is($obj->header->variables->snap_iso_pair, 0, 'Snap iso pair (0).');

# Test.
$obj = CAD::Format::DWG::AC1003->from_file(
	$data_dir->file('SNAP_ISO_PAIR_TOP.DWG')->s,
);
is($obj->header->variables->snap_iso_pair, 1, 'Snap iso pair (1).');

# Test.
$obj = CAD::Format::DWG::AC1003->from_file(
	$data_dir->file('SNAP_ISO_PAIR_RIGHT.DWG')->s,
);
is($obj->header->variables->snap_iso_pair, 2, 'Snap iso pair (2).');
