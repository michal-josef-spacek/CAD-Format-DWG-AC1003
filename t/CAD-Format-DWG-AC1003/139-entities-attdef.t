...
is($attdef1_data->entity_layer_index, 0, 'Arc layer index (0).');
is($attdef1_data->entity_size, 70, 'Entity size (70).');
...
is($attdef1_data->horiz_alignment, 3, 'Attdef horizontal alignment (3 - text_type_aligned).');
...
is($attdef1_data->entity_layer_index, 0, 'Arc layer index (0).');
is($attdef1_data->entity_size, 88, 'Entity size (88).');
...
is($attdef1_data->flags->constant, 0, 'Attdef flags - constant (0).');
is($attdef1_data->flags->invisible, 0, 'Attdef flags - invisible (0).');
is($attdef1_data->rotation_angle_in_radians, 2.35619449019234,
	'Attdef rotation angle in radians (2.35619449019234 = 135 deg).');
